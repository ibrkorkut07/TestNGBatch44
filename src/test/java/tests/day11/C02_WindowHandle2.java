...
public class C02_WindowHandle2 {
    ...
    public void Test1 () {
        ...
        softAssert.assertTrue(text1.contains(expectedText1), "The text does not contain Opening a new window");
        // Verify that the page title is “The Internet”
        String pageTitle1 = driver.getTitle();
        String expectedPageTitle1 = "The Internet";
        softAssert.assertTrue(pageTitle1.contains(expectedPageTitle1), "The title does not contain The Internet");
        // Click on "Click Here" button
        ...
        softAssert.assertTrue(pageTitle2.contains(expectedPageTitle2), "The title does not contain New Window");
        // Verify that the text on the page is “New Window”
        ...
        softAssert.assertTrue(previousTitle.contains(expectedPreviousTitle), "The title does not contain The Internet");
        */

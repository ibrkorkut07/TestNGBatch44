...
public class C03_Cookies extends TestBase {
    ...
    public void test01(){
        ...
        for (Cookie each: cookieSet2  // this foreach is just to see on the console that it is added
        ) {
            System.out.println(sayac+". cookie : " + each);
            sayac++;
        }
        ...
        sayac=1;  // from here to Assert is just to see on the console that it is deleted
